...
const SearchBar: React.FC = () => {
  const [showGoogleSearches, setShowGoogleSearches] = useState(true)
  ...
  return (
    <div className="relative flex items-center justify-center w-auto h-12 px-4 mx-3 mt-5 border border-gray-400 transition duration-150 md:hover:border-gray-500 hover:shadow-lg md:h-10 rounded-3xl md:w-2/4 md:m-auto md:mt-6">
