...
const SearchBar: React.FC = () => {
  return (
    <div className="flex items-center justify-center w-auto h-12 px-4 mx-3 mt-5 border border-gray-400 transition md:hover:border-gray-500 md:hover:shadow-lg md:h-10 rounded-3xl md:w-2/4 md:m-auto md:mt-6">
