...
const SearchBar: React.FC = () => {
  return (
    <div className="border-gray-400 border w-auto md:hover:border-gray-500 md:hover:shadow-lg  h-12 flex items-center justify-center mx-3 px-4 rounded-3xl mt-5 md:w-2/4 md:m-auto md:mt-6">
